...
def training_machine_learning_models(model_type: str, modeles: dict, validation_croisee, X_train, X_test, y_train,
                                     y_test):
...
def evaluation_of_trained_models(predictions , dict_modeles, model_type, y_test, recall,accuracy,f1score,precision,mse, r2, tab_modele, save_path):
    best=""
    scor=0
    pipeline_model={}
